...
@ContextConfiguration(locations = {MapPrinterServletTest.PRINT_CONTEXT})
public class MapPrinterServletTest extends AbstractMapfishSpringTest {
  ...
  public void testExampleRequest() throws Exception {
    ...
    this.servlet.getExampleRequest(
        DEFAULT_CONFIGURATION_FILE_KEY, request, getExampleResponseExplicit);
    ...
    doCreateAndPollAndGetReport(
        (@Nullable MockHttpServletRequest servletCreateRequest) -> {
          try {
            final MockHttpServletResponse servletCreateResponse = new MockHttpServletResponse();
            String requestData =
                "spec=" + URLEncoder.encode(loadRequestDataAsString(), Constants.DEFAULT_ENCODING);
            servlet.createReport("png", requestData, servletCreateRequest, servletCreateResponse);
            return servletCreateResponse;
          } catch (Exception e) {
            throw new AssertionError(e);
  ...
  public void testCreateReport_ForwardHttpRequests() throws Exception {
    ...
    requestFactory.registerHandler(
        input -> input != null && input.toString().equals(geotiffURL),
            ...
            (@Nullable MockHttpServletRequest servletCreateRequest) -> {
              try {
                ...
                rawRequestData
                    ...
                    .getJSONObject("imageMap")
                    .getJSONArray("layers")
                    .getJSONObject(0)
                    .put("url", geotiffURL);
                String requestData = rawRequestData.toString(2);
                servlet.createReport(
                    "png", requestData, servletCreateRequest, servletCreateResponse);
  ...
  public void testCreateReport_Email() throws Exception {
    ...
    assertArrayEquals(
        new Address[] {new InternetAddress("info@camptocamp.com")}, msg.getAllRecipients());
  ...
  public void testCreateReport_Email_S3() throws Exception {
    ...
    final String requestData = requestJson.getInternalObj().toString();
    servlet.createReport(
        "email-s3", "png", requestData, servletCreateRequest, servletCreateResponse);
    ...
    assertEquals(
        String.format(
            "Please find the requested document there: https://example"
                + ".com/test-bucket/%s/test-report.png",
            ref),
        body.getContent());
  }
  ...
  private String doCreateAndPollAndGetReport(
    ...
    while (!reportReady) {
      ...
      servlet.getStatusPath(ref, servletStatusRequest, servletStatusResponse);
    ...
    servlet.getReportPath(ref, false, servletGetReportResponse);
  ...
  public void testCreateReport_FailureInvalidUrl() throws Exception {
    ...
    servlet.getStatusPath(ref, statusRequest, statusResponse);
    ...
    assertTrue(
        statusJson
            .getString(MapPrinterServlet.JSON_ERROR)
            .startsWith(
                "java.lang.IllegalArgumentException: http://invald-url.com/sampleGeoTiff.tif not"
                    + " registered with"));
  }

  private void waitForFailure(String ref)
  ...
  public void testCancel() throws Exception {
    ...
    servlet.cancelPath(ref, servletCancelResponse);
  ...
  public void testCancel_WrongRef() throws Exception {
    ...
    MockHttpServletResponse servletCancelResponse = new MockHttpServletResponse();
    servlet.cancelPath("invalid-ref", servletCancelResponse);
  ...
  public void testCreateReport_Timeout() throws Exception {
    ...
    String requestData = loadRequestDataAsString();
    servlet.createReport(
        "timeout", "png", requestData, servletCreateRequest, servletCreateResponse);
    final PJsonObject createResponseJson =
        parseJSONObjectFromString(servletCreateResponse.getContentAsString());
    assertTrue(createResponseJson.has(MapPrinterServlet.JSON_PRINT_JOB_REF));
    assertEquals(HttpStatus.OK.value(), servletCreateResponse.getStatus());
  ...
  public void testCreateReport_AbandonedTimeout() throws Exception {
    ...
    // wait for 2 seconds without making a status request, the job should be canceled after that
    // time
    Thread.sleep(2000);
  ...
  private void waitForCanceled(String ref)
      throws IOException, ServletException, InterruptedException {
    while (true) {
      MockHttpServletResponse servletGetReportResponse = new MockHttpServletResponse();
      servlet.getReportPath(ref, false, servletGetReportResponse);
  ...
  private void waitForNotCanceled(String ref)
      throws IOException, ServletException, InterruptedException {
    while (true) {
      MockHttpServletResponse servletGetReportResponse = new MockHttpServletResponse();
      servlet.getReportPath(ref, false, servletGetReportResponse);
  ...
  public void testCreateReportAndGet_OutputName() throws Exception {
    ...
    this.servlet.createReportAndGetNoAppId(
        "png",
        requestJson.getInternalObj().toString(2),
        false,
        servletCreateRequest,
        servletCreateResponse);
    assertEquals(HttpStatus.OK.value(), servletCreateResponse.getStatus());
  ...
  public void testCreateReportAndGet_Timeout() throws Exception {
    ...
    this.servlet.createReportAndGet(
        "timeout", "png", requestData, false, servletCreateRequest, servletCreateResponse);
  ...
  public void testGetStatus_InvalidRef() throws Exception {
    ...
    MockHttpServletRequest servletStatusRequest =
        new MockHttpServletRequest("GET", "/print/status/" + ref + ".json");
    MockHttpServletResponse servletStatusResponse = new MockHttpServletResponse();
    servlet.getStatusPath(ref, servletStatusRequest, servletStatusResponse);
  ...
  public void testGetCapabilitiesWithAppId_NotPretty() throws Exception {
    ...
    configFiles.put(
        "default", getFile(MapPrinterServletTest.class, "config.yaml").getAbsolutePath());
    configFiles.put(
        "app2",
        getFile(
    ...
    final PJsonObject app2GetInfoJson =
        parseJSONObjectFromString(app2GetInfoResponse.getContentAsString());
  ...
  public void testGetStatus_WaitingRunning() throws Exception {
    ...
    String requestData = loadRequestDataAsString();
    servlet.createReport(
        "timeout", "png", requestData, servletCreateRequest1, servletCreateResponse1);
    ...
    servlet.createReport(
        "timeout", "png", requestData, servletCreateRequest2, servletCreateResponse2);
    final PJsonObject createResponseJson2 =
    ...
    final MockHttpServletRequest statusRequest = new MockHttpServletRequest();
    final MockHttpServletResponse statusResponse = new MockHttpServletResponse();
    servlet.getStatusPath(ref2, statusRequest, statusResponse);
