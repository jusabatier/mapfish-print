...
public class CreateMapProcessorAoiTest extends AbstractMapfishSpringTest {
  ...
  public void testExecute() throws Exception {
    ...
    createMap(
        template,
        "expectedSimpleImage-render-thinline.png",
        RENDER,
        "file://thinline.sld",
        false,
        true,
    ...
    createMap(
        ...
        AreaOfInterest.AoiDisplay.NONE,
        null,
        false,
        null,
        0);
    ...
    createMap(
        template,
        "expectedSimpleImage-render-polygon-svg-transparent.png",
        RENDER,
        createJsonStyle().toString(),
        true,
        null,
    ...
    createMap(
        template,
        "expectedSimpleImage-render-polygon-svg.png",
        RENDER,
        createJsonStyle().toString(),
        true,
        true,
    ...
    createMap(
        template,
        "expectedSimpleImage-rotate-clip-svg.png",
        CLIP,
        null,
        true,
        setRotationUpdater,
  ...
  private void createMap(
      ...
      String styleRef,
      boolean useSVG,
      Function<PJsonObject, Void> requestUpdater,
      double tolerance)
      throws IOException,
          JSONException,
          TranscoderException,
