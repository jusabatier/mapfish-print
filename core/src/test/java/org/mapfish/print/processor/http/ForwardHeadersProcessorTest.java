...
@ContextConfiguration(
    locations = {
      "classpath:org/mapfish/print/processor/http/forward-headers/add-custom-processor-application"
          + "-context.xml"
    })
public class ForwardHeadersProcessorTest extends AbstractHttpProcessorTest {
  ...
  protected void addExtraValues(Values values) throws JSONException {
    ...
    JSONObject inner =
        new JSONObject(
            "{\"header1\": [\"header1-v1\",\"header1-v2\"], \"header2\": [\"header2-value\"],"
  ...
  public void testForwardAll() throws Exception {
    ...
    final Configuration config =
        configurationFactory.getConfig(getFile(baseDir() + "/config-forward-all.yaml"));
  ...
  public static class TestProcessor extends AbstractTestProcessor {
    ...
    public Void execute(TestParam values, ExecutionContext context) throws Exception {
      ...
      assertArrayEquals(
          new Object[] {"header1-v1", "header1-v2"}, request.getHeaders().get("header1").toArray());
      assertArrayEquals(
  ...
  public static class TestProcessor2 extends AbstractTestProcessor {
    ...
    public Void execute(TestParam values, ExecutionContext context) throws Exception {
      ...
      assertArrayEquals(
          new Object[] {"header2-value"}, request.getHeaders().get("header2").toArray());
      assertArrayEquals(
          new Object[] {"header3-value"}, request.getHeaders().get("header3").toArray());
      return null;
    }
  }
}
