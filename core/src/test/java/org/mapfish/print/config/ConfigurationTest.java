...
public class ConfigurationTest {
  ...
  public void testGetDefaultStyle_NotInMap() {
    ...
    assertStyleType(
        RasterSymbolizer.class, configuration.getDefaultStyle(Constants.Style.Raster.NAME));
  ...
  public void testGetDefaultStyle_GeomNotInMap() {
    ...
    assertStyleType(
        Symbolizer.class, configuration.getDefaultStyle(Constants.Style.Grid.NAME_LINES));
  ...
  public void testTemplateAccess() throws Exception {
    ...
    assertCorrectTemplates(
        configuration, unrestricted, restricted, AuthenticationCredentialsNotFoundException.class);
  ...
  public void testTemplateAccess_ConfigHasAccess() throws Exception {
    ...
    assertAccessTemplate_ConfigSecured(
        configuration, AuthenticationCredentialsNotFoundException.class);
  ...
  public void testJdbcDrivers() {
    ...
    config.setConfigurationFile(
        AbstractMapfishSpringTest.getFile(
            ...
            "/org/mapfish/print/config/config" + "-test-application-context" + ".xml"));
