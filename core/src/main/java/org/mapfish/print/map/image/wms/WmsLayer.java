...
public final class WmsLayer extends AbstractSingleImageLayer {
  ...
  /**
   * If supported by the WMS server, a parameter "angle" can be set on "customParams" or
   * "mergeableParams". In this case the rotation will be done natively by the WMS.
   */
  @Override
