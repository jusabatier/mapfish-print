 ...
 *
 * <p>Version 1 is compatible with mapfish print &lt;= v2 and is based on the OpenLayers v2 styling.
 ...
 *
 * <p>Version 2 uses the same property names as version 1 but has a different structure. The layout
 * is as follows:
 *
 * <pre><code>
 * {
 ...
 * </code></pre>
 *
 * <p>As illustrated above the style consists of:
 *
 * <ul>
 *   <li>The version number (2) (required)
 *   <li>Common values which can be referenced in symbolizer property values.(optional)
 *       <p>Values can be referenced in the value of a property with the pattern: ${valName}
 *       <p>Value names can only contain numbers, characters, _ or -
 *       <p>Values do not have to be the full property they will be interpolated. For example:
 *       <code>The value is ${val}</code>
 *   <li>Defaults property definitions(optional):
 ...
 *       in the system.
 *       <p>The only difference between a value and a default is that the default has a well known
 *       name, therefore defaults can also be used as values.
 *   <li>All the styling rules (At least one is required)
 ...
 *       <p>The filter is either <code>*</code> or an <a
 *       href="http://docs.geoserver.org/stable/en/user/filter/ecql_reference.html#filter-ecql-reference">
 *       ECQL Expression</a>) surrounded by square brackets. For example: [att &lt; 23].
 *       <p><em>WARNING:</em> At the moment DWITHIN and BEYOND spatial functions take a unit
 ...
 *       <ul>
 *         <li>Default property values (optional):
 ...
 * <code>[ ]</code>.
 *
 * <p>The items below with (ECQL) can have ECQL expressions.
 *
 * <ul>
 ...
 *   <li><strong>rotation</strong> (ECQL) - (point) The rotation of the point graphic
 *   <li><strong>externalGraphic</strong> - (point) one of the two options for declaring the point
 ...
 *   <li><strong>graphicName</strong> (ECQL) - (point) one of the two options for declaring the
 ...
 *       <ul>
 *         <li>WellKnownMarks: cross, star, triangle, arrow, X, hatch, square
 ...
 *         <li>TTFMarkFactory: ttf://fontName#code (where fontName is a TrueType font and the code
 ...
 *       graphic
 *   <li><strong>pointRadius</strong> (ECQL) - (point) the size at which to draw the point graphic
 *   <li><strong>strokeColor</strong> (ECQL) - (line, point, polygon) the color to use when drawing
 *       a line or the outline of a polygon or point graphic
 *   <li><strong>strokeOpacity</strong> (ECQL) - (line, point, polygon) the opacity to use when
 *       drawing the line/stroke
 *   <li><strong>strokeWidth</strong> (ECQL) - (line, point, polygon) the widh of the line/stroke
 *   <li><strong>strokeLinecap</strong> (ECQL) - (line, point, polygon) the style used when drawing
 *       the end of a line.
 *       <p>Options: butt (sharp square edge), round (rounded edge), and square (slightly elongated
 *       square edge). Default is butt
 *   <li><strong>strokeLinejoin</strong> (ECQL) - (line, polygon) the style to controls how line
 ...
 *   <li><strong>strokeDashstyle</strong> - (line, point, polygon) A string describing how to draw
 *       the line or an array of floats describing the line lengths and space lengths:
 *       <ul>
 *         <li>dot - translates to dash array: [0.1, 2 * strokeWidth]
 *         <li>dash - translates to dash array: [2 * strokeWidth, 2 * strokeWidth]
 *         <li>dashdot - translates to dash array: [3 * strokeWidth, 2 * strokeWidth, 0.1, 2 *
 *             strokeWidth]
 *         <li>longdash - translates to dash array: [4 * strokeWidth, 2 * strokeWidth]
 *         <li>longdashdot - translates to dash array: [5 * strokeWidth, 2 * strokeWidth, 0.1, 2 *
 *             strokeWidth]
 *         <li>{string containing spaces to delimit array elements} - Example: [1 2 3 1 2]
 *       </ul>
 *   <li><strong>strokeDashoffset</strong> - (line, point, polygon) A number representing where to
 *       start the dash.
 *   <li><strong>fontColor</strong> (ECQL) - (text) the color of the text drawn
 *   <li><strong>fontFamily</strong> (ECQL) - (text) the font of the text drawn
 *   <li><strong>fontSize</strong> (ECQL) - (text) the font size of the text drawn
 *   <li><strong>fontStyle</strong> (ECQL) - (text) the font style of the text drawn
 *   <li><strong>fontWeight</strong> (ECQL) - (text) the font weight of the text drawn
 *   <li><strong>haloColor</strong> (ECQL) - (text) the color of the halo around the text
 *   <li><strong>haloOpacity</strong> (ECQL) - (text) the opacity of the halo around the text
 *   <li><strong>haloRadius</strong> (ECQL) - (text) the radius of the halo around the text
 *   <li><strong>label</strong> (ECQL) - (text) the expression used to create the label e. See the
 *       section on labeling for more details
 *   <li><strong>labelAlign</strong> - (Point Placement) the indicator of how to align the text with
 *       respect to the geometry. This property must have 2 characters, the x-align and the y-align.
 *       <p>X-Align options:
 *       <ul>
 *         <li>l - align to the left of the geometric center
 *         <li>c - align on the center of the geometric center
 *         <li>r - align to the right of the geometric center
 *       </ul>
 *       <p>Y-Align options:
 *       <ul>
 *         <li>b - align to the bottom of the geometric center
 *         <li>m - align on the middle of the geometric center
 *         <li>t - align to the top of the geometric center
 *       </ul>
 ...
 *   <li><strong>labelAnchorPointY</strong> (ECQL) - (Point Placement) The point along the y axis
 ...
 *   <li><strong>labelPerpendicularOffset</strong> (ECQL) - (Line Placement) If this property is
 ...
 *
 * <p>Labeling in this style format is done by defining a text symbolizer ("type": "text"). All text
 * symbolizers consist of:
 *
 * <ul>
 *   <li><a href="#labelproperties">Label Property</a>
 *   <li><a href="#haloproperties">Halo Properties</a>
 *   <li><a href="#otherproperties">Font/weight/style/color/opacity</a>
 *   <li><a href="#placementproperties">Placement Properties</a>
 *   <li><a href="#vendoroptions">Vendor Options</a>
 * </ul>
 *
 * <h3 id="labelproperties">Label Property <a class="headerlink" href="#labelproperties">¶</a></h3>
 *
 * <p>The label property defines what label will be drawn for a given feature. The value is either a
 ...
 *
 * <p>A halo is a space around the drawn label text that is color (using the halo properties). A
 ...
 *
 * <h3 id="otherproperties">Font/weight/style/color/opacity <a class="headerlink"
 * href="#otherproperties">¶</a></h3>
 *
 * <p>The Font/weight/style/color/opacity properties define how the label text is drawn. They are
 * for the most part equivalent to the similarly named css and SLD properties.
 *
 * <h3 id="placementproperties">Placement Properties <a class="headerlink"
 * href="#placementproperties">¶</a></h3>
 *
 * <p>An important part of defining a text symbolizer is defining where the text/label will be
 ...
 * the text symbolizer.
 *
 * <p>It is important to realize that since only one type of placement can be used, an error will be
 ...
 *
 * <p><strong>Point Placement</strong>
 *
 * <p>Point placement defines an <em>anchor point</em> which is the point to draw the text relative
 ...
 *
 * <p>After <em>anchor point</em>, comes <em>displacement</em> displacement defines the distance
 * from the anchor point to start the label. The combination of the two values determines the final
 * location of the label.
 *
 * <p>Lastly, there is a label rotation which defines the orientation of the label.
 *
 * <p>There are two ways to define the anchor point, either the <em>labelAnchorPointX/Y</em>
 ...
 *
 * <p>For text symbolizers the following vendor options are available:
 *
 * <ul>
 *   <li><strong>allowOverruns</strong> (false): When false does not allow labels on lines to get
 *       beyond the beginning/end of the line. By default a partial overrun is tolerated, set to
 *       false to disallow it.
 *   <li><strong>autoWrap</strong> (400): Number of pixels are which a long label should be split
 *       into multiple lines. Works on all geometries, on lines it is mutually exclusive with the
 *       followLine option.
 *   <li><strong>conflictResolution</strong> (true): Enables conflict resolution (default, true)
 ...
 *   <li><strong>followLine</strong> (true): When true activates curved labels on linear geometries.
 *       The label will follow the shape of the current line, as opposed to being drawn a tangent
 *       straight line
 *   <li><strong>goodnessOfFit</strong> (90): Sets the percentage of the label that must sit inside
 *       the geometry to allow drawing the label. Works only on polygons.
 *   <li><strong>group</strong> (false): If true, geometries with the same labels are grouped and
 *       considered a single entity to be labeled. This allows to avoid or control repeated labels.
 *   <li><strong>maxDisplacement</strong> (400): The distance, in pixel, a label can be displaced
 *       from its natural position in an attempt to find a position that does not conflict with
 *       already drawn labels.
 *   <li><strong>spaceAround</strong> (50): The minimum distance between two labels, in pixels.
 * </ul>
 *
 * <p>Example
 *
 ...
 * href="http://docs.geotools.org/latest/userguide/library/render/style.html#textsymbolizer">GeoTools
 * documentation</a>.
 *
 ...
 *       http://docs.geoserver.org/stable/en/user/filter/ecql_reference.html#ecql-expr</a>
 *   <li><a
 *       href="http://udig.refractions.net/files/docs/latest/user/Constraint%20Query%20Language.html">
 *       http://udig.refractions.net/files/docs/latest/user/Constraint%20Query%20Language.html</a>
 *   <li><a
 *       href="http://docs.geoserver.org/stable/en/user/filter/function_reference.html#filter-function-reference">
 *       http://docs.geoserver.org/stable/en/user/filter/function_reference.html#filter-function-reference</a>
 *   <li><a href="http://docs.geotools.org/stable/userguide/library/cql/ecql.html">
 *       http://docs.geotools.org/stable/userguide/library/cql/ecql.html</a>
 *   <li><a href="http://docs.geoserver.org/latest/en/user/tutorials/cql/cql_tutorial.html">
 *       http://docs.geoserver.org/latest/en/user/tutorials/cql/cql_tutorial.html</a>
 * </ul>
 */
public final class MapfishStyleParserPlugin implements StyleParserPlugin {
  ...
  public Optional<Style> parseStyle(
    ...
    final Optional<Style> styleOptional =
        tryParse(configuration, styleString, clientHttpRequestFactory);
