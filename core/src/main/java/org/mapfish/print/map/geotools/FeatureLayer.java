 ...
 *
 * <p>This layer type is only intended for internal use, for example to render the bbox rectangle in
 * the overview map.
 */
public final class FeatureLayer extends AbstractFeatureSourceLayer {
  ...
  public static final class Plugin extends AbstractFeatureSourceLayerPlugin<FeatureLayerParam> {
    ...
    public FeatureLayer parse(
        @Nonnull final Template template, @Nonnull final FeatureLayerParam param) {
  ...
  public static class FeatureLayerParam extends AbstractLayerParams {
     ...
     *
     * <p>(will default to {@link org.mapfish.print.config.Configuration#defaultToSvg}).
     */
