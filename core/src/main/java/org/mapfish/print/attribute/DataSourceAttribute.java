 ...
 * {@link org.mapfish.print.processor.jasper.DataSourceProcessor} will process the datasource
 * attribute and create a Jasper datasource that contains all the tables.
 *
 * <p>This datasource must be used in tandem with the {@link
 * org.mapfish.print.processor.jasper.DataSourceProcessor} processor (see <a
 * href="processors.html#!createDataSource">!createDataSource</a> processor).
 *
 * <p>The json data of this attribute is special since it represents an array of attributes, each
...
public final class DataSourceAttribute implements Attribute {
  ...
  public DataSourceAttributeValue parseAttribute(
      @Nonnull final Template template, @Nullable final PArray jsonValue) throws JSONException {
    final PArray pValue;
  ...
  public static final class DataSourceAttributeValue {
    /**
     * The array of attribute data. Each element in the array is the attribute data for one row in
     * the resulting datasource (as processed by {@link
