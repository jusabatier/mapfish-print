...
public final class AreaOfInterest {
   ...
   *
   * <p>(will default to {@link org.mapfish.print.config.Configuration#defaultStyle}).
   */
  @HasDefaultValue public Boolean renderAsSvg;

  private Geometry polygon;

  /**
   * Tests that the area is valid geojson, the style ref is valid or null and the display is
   * non-null.
   */
  ...
  public SimpleFeatureCollection areaToFeatureCollection(
    ...
    final SimpleFeature feature =
        SimpleFeatureBuilder.build(
            typeBuilder.buildFeatureType(), new Object[] {this.polygon}, "aoi");
  ...
  public enum AoiDisplay {
    ...
    CLIP,
    /**
     * Do not show the Area of interest on the map. In this case another processor will likely make
     * use of the AOI.
     */
    NONE
  }
